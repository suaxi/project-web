  ...
  <div class="containers">
    <el-container style="align-items: stretch">
      <el-main class="flow-viewer">
        ...
        <!-- 流程图显示 -->
        <div ref="flowCanvas" v-loading="loading" class="canvas" />
        <!--  按钮区域  -->
...
<script>
import { CustomViewer as BpmnViewer } from '@/components/workflow/Process/common'
...
<style lang="scss">
@import "@/components/workflow/Process/style/flow-viewer";
</style>
