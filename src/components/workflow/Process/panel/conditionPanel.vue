<template>
  <div>
    <el-form label-width="100px" size="small" @submit.native.prevent>
      ...
      <el-form-item v-if="bpmnFormData.type === 'condition'" key="condition" label="条件格式">
        <el-select v-model="bpmnFormData.conditionType">
          <el-option label="表达式" value="expression" />
          <el-option label="脚本" value="script" />
        </el-select>
      </el-form-item>
      <el-form-item v-if="bpmnFormData.conditionType && bpmnFormData.conditionType === 'expression'" key="express" label="表达式">
      ...
      <template v-if="bpmnFormData.conditionType && bpmnFormData.conditionType === 'script'">
        ...
        <el-form-item v-if="bpmnFormData.scriptType === 'inlineScript'" key="body" label="脚本">
          <el-input v-model="bpmnFormData.body" type="textarea" clearable @change="updateFlowCondition" />
        </el-form-item>
        <el-form-item v-if="bpmnFormData.scriptType === 'externalScript'" key="resource" label="资源地址">
